...
SurfelsVisualizationPass::SurfelsVisualizationPass() {}

void SurfelsVisualizationPass::createRenderPass(VkDevice device, VkFormat format, VkPhysicalDevice physicalDevice)
{
    ...
    dependencies[1].dstAccessMask = VK_ACCESS_MEMORY_READ_BIT | VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT;;
...
void SurfelsVisualizationPass::createImageAttachments(VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool, VkQueue graphicsQueue, VkExtent2D swapChainExtent)
{
    // Attachment 0: Color
    ...
    // Attachment de profundidad
    depthBufferCreator.createDepthResources(device, physicalDevice, commandPool, graphicsQueue, swapChainExtent);
}

void SurfelsVisualizationPass::createFramebuffers(uint32_t numImageViews, SwapChainManager swapChainManager, VkDevice device, VkPhysicalDevice physicalDevice, VkCommandPool commandPool,
                                      VkQueue graphicsQueue, VkExtent2D swapChainExtent)
{
    ...
    attachments[1] = depthBufferCreator.depthImageView;
...
void SurfelsVisualizationPass::cleanup(VkDevice device)
{
...
void SurfelsVisualizationPass::cleanupFramebuffers(VkDevice device)
{
    depthBufferCreator.cleanupDepthResources(device);
    for (auto &framebuffer : framebuffers)
    {
...
VkImageView SurfelsVisualizationPass::getColorImageView()
{
