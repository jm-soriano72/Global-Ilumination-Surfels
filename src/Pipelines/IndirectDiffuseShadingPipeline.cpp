...
void IndirectDiffuseShadingPipeline::createGraphicsPipeline(VkDevice device, VkExtent2D swapChainExtent, VkDescriptorSetLayout descriptorSetLayout, VkRenderPass renderPass)
{
    ...
    auto fragmentShaderCode = ShaderStagesCreator::readFile(RESOURCES_PATH "shaders/indirect_diffuse_shading.spv");
