...
void RaytracingPipeline::createGraphicsPipeline(VkDevice device, VkExtent2D swapChainExtent, VkDescriptorSetLayout descriptorSetLayout, VkRenderPass renderPass)
{
    ...
    auto vertShaderCode = ShaderStagesCreator::readFile(RESOURCES_PATH "shaders/shader_raytracing_vertex.spv");
    ...
    auto fragmentShaderCode = ShaderStagesCreator::readFile(RESOURCES_PATH "shaders/shader_raytracing_frag.spv");
