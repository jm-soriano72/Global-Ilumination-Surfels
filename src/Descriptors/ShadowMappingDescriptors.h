...
#include "Buffers/ShadowMappingUniformBuffer.h"
...
class ShadowMappingDescriptors : public PipelineDescriptors
{
public:
    void createDescriptors(VkDevice device, uint32_t MAX_FRAMES_IN_FLIGHT, std::vector<VkBuffer> uniformBuffers);
