...
void SSAOCompositionDescriptors::createDescriptors(VkDevice device, uint32_t MAX_FRAMES_IN_FLIGHT, std::vector<VkBuffer> uniformSSAOParamsBuffers, VkSampler colorSampler,
                                                   VkImageView positionImageView, VkImageView normalImageView, VkImageView albedoImageView, VkImageView colorSSAOBlurImageView)
{
    ...
    for (size_t i = 0; i < MAX_FRAMES_IN_FLIGHT; i++)
    {
        ...
        // Binding 2 -> Imagen con el albedo de la primera pasada
        ...
        // Binding 4 -> Imagen con el color de la pasada de SSAO Blur
...
void SSAOCompositionDescriptors::cleanupDescriptors(VkDevice device)
{
    vkDestroyDescriptorPool(device, descriptorPool, nullptr);
    vkDestroyDescriptorSetLayout(device, descriptorSetLayout, nullptr);
}

VkDescriptorSetLayout SSAOCompositionDescriptors::getDescriptorSetLayout()
{
    return descriptorSetLayout;
}

VkDescriptorSet SSAOCompositionDescriptors::getDescriptorSet(int index)
{
