...
void ShadowsSSAOCompositionDescriptors::createDescriptors(VkDevice device, uint32_t MAX_FRAMES_IN_FLIGHT, std::vector<VkBuffer> uniformSSAOParamsBuffers, VkSampler colorSampler,
...
void ShadowsSSAOCompositionDescriptors::cleanupDescriptors(VkDevice device)
{
    vkDestroyDescriptorPool(device, descriptorPool, nullptr);
    vkDestroyDescriptorSetLayout(device, descriptorSetLayout, nullptr);
}

VkDescriptorSetLayout ShadowsSSAOCompositionDescriptors::getDescriptorSetLayout()
{
    return descriptorSetLayout;
}

VkDescriptorSet ShadowsSSAOCompositionDescriptors::getDescriptorSet(int index)
{
