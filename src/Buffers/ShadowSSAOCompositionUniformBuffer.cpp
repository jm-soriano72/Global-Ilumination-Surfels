...
void ShadowSSAOCompositionUniformBuffer::createUniformBuffers(VkDevice device, VkPhysicalDevice physicalDevice, uint32_t MAX_FRAMES_IN_FLIGHT,
...
void ShadowSSAOCompositionUniformBuffer::updateUniformBuffers(uint32_t currentImage, uint32_t width, uint32_t height, Camera *camera, LightsData sceneLights)
{
...
void ShadowSSAOCompositionUniformBuffer::createMVPUniformBuffers(VkDevice device, VkPhysicalDevice physicalDevice, uint32_t MAX_FRAMES_IN_FLIGHT, uint32_t width, uint32_t height, Camera *camera)
{
...
void ShadowSSAOCompositionUniformBuffer::createLightsBuffers(VkDevice device, VkPhysicalDevice physicalDevice, uint32_t MAX_FRAMES_IN_FLIGHT, LightsData sceneLights)
{
...
void ShadowSSAOCompositionUniformBuffer::createMainLightDataBuffers(VkDevice device, VkPhysicalDevice physicalDevice, uint32_t MAX_FRAMES_IN_FLIGHT)
{
...
void ShadowSSAOCompositionUniformBuffer::updateMVPUniformBuffer(uint32_t currentImage, uint32_t width, uint32_t height, Camera *camera)
{
...
void ShadowSSAOCompositionUniformBuffer::updateLightsBuffer(uint32_t currentImage, LightsData sceneLights)
{
    // Se pasa la información al buffer
    memcpy(lightBuffersMapped[currentImage], &sceneLights, sizeof(sceneLights));
}

void ShadowSSAOCompositionUniformBuffer::updateMainLightDataBuffer(uint32_t currentImage)
{
    // Se pasa la información al buffer
    memcpy(mainLightDataBuffersMapped[currentImage], &uniformDataOffscreen, sizeof(uniformDataOffscreen));
}

void ShadowSSAOCompositionUniformBuffer::cleanup(VkDevice device)
{
...
std::vector<VkBuffer> ShadowSSAOCompositionUniformBuffer::getMVPBuffers()
{
    return uniformMVPBuffers;
}

std::vector<VkBuffer> ShadowSSAOCompositionUniformBuffer::getLightsBuffers()
{
    return lightBuffers;
}

std::vector<VkBuffer> ShadowSSAOCompositionUniformBuffer::getMainLightBuffers()
{
